  ...
  return (
    <AdminLayout title="Pengaturan Cetak Dokumen">
      <div className="max-w-4xl space-y-6">
        {/* Modul Proteksi Password Cetak Dokumen Publik */}
        <PrintSecurityManager />

        <div className="flex items-center justify-between pt-4 border-t border-slate-200">
          <div>
            <h3 className="text-base font-bold text-slate-800">Tata Letak & Format Kertas Dokumen</h3>
            <p className="text-xs text-gray-500">Atur tata letak halaman cetak (Margin, Ukuran Kertas, dan Font) secara global.</p>
          </div>
