...
import { Plus, Pencil, Trash2, Image as ImageIcon, Upload, X, Loader2, RefreshCw, Video, Play, Film, Sparkles, CheckCircle2, FileVideo, ExternalLink } from 'lucide-react';
import { showSuccess, showError } from '@/utils/toast';
import AdminLayout from '@/components/admin/AdminLayout';
import { compressImage, uploadImageToStorage, uploadMediaToStorage, getYouTubeEmbedUrl, getYouTubeThumbnail, generateVideoThumbnail } from '@/utils/imageCompression';
