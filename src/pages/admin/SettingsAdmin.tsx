    ...
    <AdminLayout title="Pengaturan Website">
      <div className="max-w-5xl mx-auto space-y-6 w-full min-w-0">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h3 className="text-sm font-bold text-emerald-600 flex items-center gap-2">
                    <Globe className="w-4 h-4" /> Identitas Website & Nama Aplikasi
                  </h3>

                  {/* Banner Info Pemisahan Nama Aplikasi vs Nama Madrasah */}
                  <div className="p-3.5 rounded-2xl bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200/80 text-emerald-950 space-y-2 text-xs">
                    <p className="font-bold flex items-center gap-1.5 text-emerald-900">
                      <Sparkles className="w-4 h-4 text-emerald-600 shrink-0" />
                      Pemisahan Nama Aplikasi & Nama Resmi Madrasah
                    </p>
                    ...
                    {identitas?.nama_madrasah && (
                      <div className="pt-1 flex items-center justify-between gap-2 border-t border-emerald-200/60">
                        ...
                        <Button
                          ...
                          className="h-7 text-[10px] font-bold bg-white text-emerald-700 border-emerald-300 hover:bg-emerald-100 rounded-lg shrink-0 gap-1"
                        >
                  ...
                  <div className="p-4 rounded-2xl bg-white border border-emerald-200/80 shadow-xs space-y-4">
                    <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                      <span className="text-xs font-bold text-slate-900 flex items-center gap-1.5 uppercase tracking-wider">
                        ...
                        2 Field Nama Judul Header Navbar (Warna & Font Berbeda)
                      </span>
        ...
        <TabsContent value="seo">
          ...
          <div className="mb-6 p-5 sm:p-6 rounded-3xl bg-gradient-to-r from-emerald-950 via-teal-900 to-slate-900 text-white shadow-2xl border-2 border-emerald-500/40 relative overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-5 relative z-10">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-emerald-500 to-teal-400 flex items-center justify-center shrink-0 shadow-lg shadow-emerald-500/30">
                  <Zap className="w-7 h-7 text-white animate-pulse" />
                </div>
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    <h3 className="text-lg font-black tracking-tight text-white">FITUR PAMUNGKAS: SOLUSI OPENGRAPH & THUMBNAIL MEDSOS</h3>
                    <span className="bg-emerald-400/20 text-emerald-300 border border-emerald-400/50 text-[10px] font-black px-2.5 py-0.5 rounded-full uppercase tracking-wider flex items-center gap-1">
                      <CheckCircle2 className="w-3 h-3 text-emerald-400" /> Otomatis & Presisi
                    </span>
                  </div>
                  <p className="text-xs text-emerald-100/90 mt-1.5 leading-relaxed max-w-3xl">
              ...
              <div className="flex flex-wrap items-center gap-3 shrink-0 w-full lg:w-auto">
                <Button
                  ...
                  disabled={saving}
                  className="bg-gradient-to-r from-amber-400 via-emerald-400 to-emerald-500 hover:from-amber-500 hover:to-emerald-600 text-slate-950 font-black rounded-2xl text-xs h-12 px-5 shadow-xl shadow-emerald-500/20 gap-2 border border-amber-300/60 w-full sm:w-auto"
                >
                  {saving ? <Loader2 className="w-4 h-4 animate-spin" /> : <Zap className="w-4 h-4 text-slate-950 fill-slate-950" />}
                  <span>PERBAIKI & RESET OPENGRAPH SEKARANG</span>
                </Button>
                ...
                <Button
                  ...
                  disabled={saving}
                  variant="outline"
                  className="bg-white/10 hover:bg-white/20 text-white font-bold rounded-2xl text-xs h-12 px-4 gap-2 border-white/20 w-full sm:w-auto"
                >
