...
const TeachersAdmin = () => {
  ...
  const handleExportCSV = () => {
    const headers = ['No', 'Nama Guru', 'NIP', 'NIK', 'Pendidikan', 'Sertifikasi', 'Jabatan', 'Mapel Diampu', 'Mengajar Kelas', 'Gender', 'No HP', 'Email', 'Status'];
                    ...
                    <tr key={teacher.id} className="hover:bg-emerald-50/30 transition-colors">
                      ...
                      <td className="p-3.5 border-r border-slate-100">
                        {teacher.mengajar_kelas ? (
                          <Badge className="bg-teal-50 text-teal-800 border-teal-200 font-bold text-[11px] px-2.5 py-0.5 rounded-lg">
                            {teacher.mengajar_kelas}
                          </Badge>
                        ) : (
